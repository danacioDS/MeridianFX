import {
  FX_PAIRS,
  FX_MARKET_CONVENTION,
} from "../../constants/fxPairs";

interface UniverseSelectorProps {
  /**
   * Compatibilidad con páginas existentes.
   * El universo canónico actual proviene de FX_PAIRS.
   */
  currencies?: string[];
  selected: string;
...
export function UniverseSelector({
  ...
  return (
    <div className="border border-line rounded-xl px-4 py-2.5 flex items-center gap-4 flex-wrap bg-paper">
      ...
      {showConvention && (
        <div
          className="text-[10px] text-muted ml-2 hidden lg:block"
          title={FX_MARKET_CONVENTION.text}
        >
